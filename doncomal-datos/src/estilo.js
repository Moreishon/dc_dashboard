...
// El ancho de la app de compras. Mobile-first: en escritorio queda una columna
// centrada, que es como se ve un tablero en el celular de la cocina.
export const ANCHO = '480px';
